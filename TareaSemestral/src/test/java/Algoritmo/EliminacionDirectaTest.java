...
class EliminacionDirectaTest {
    ...
    public void setup() {
        ...
        jugador3 = new Deportista("Ana2","9999","22");
    ...
    void jugarPartida() {
        ...
        assertEquals(true,torneo.getGanadores().contains(jugador1));  // Envia al jugador 1 a el array de ganadores
        assertEquals(false,torneo.getParticipantes().contains(jugador2));  // Elimina de participantes al jugador 2
        torneo.selectWinner = true; // gana el segundo
        torneo.jugar(encuentro2);
        assertEquals(true,torneo.getGanadores().contains(jugador4));
        assertEquals(false,torneo.getParticipantes().contains(jugador3));
